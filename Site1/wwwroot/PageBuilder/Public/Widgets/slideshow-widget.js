...
(function (slideshowWidget) {
    ...
    slideshowWidget.addSwiper = function (id, swiper) {
        var found = window.Site1.slideshowWidget.getSwiper(id);
    ...
    slideshowWidget.initSwiper = function (swiperId, editMode, transitionDelay, transitionSpeed) {
        ...
        window.Site1.slideshowWidget.addSwiper(swiperId, swiper);
    };
    ...
    slideshowWidget.getCurrentSwiper = function (editor, swiperGuidAttribute) {
        ...
        return window.Site1.slideshowWidget.getSwiper(editor.getAttribute(swiperGuidAttribute)).swiper;
    };
...
}(window.Site1.slideshowWidget = window.Site1.slideshowWidget || {}));
